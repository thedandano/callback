...
Specify the quality gates and pre-commit checks that guard code quality and prevent
unreviewed AI-generated or low-quality code from being committed. Covers pre-commit
framework setup, linting, type checking, and AI-slop scoring.
## Requirements
