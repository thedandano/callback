...
Find plausible, San Diego-workable software or AI engineering leads while avoiding duplicates, snippets, stale postings, and spammy application behavior.
...
- Official FAANG career/source pages for Meta, Amazon, Apple, Netflix, and Google.

## Curation Rules

1. Apply the location gate first:
   - keep San Diego onsite/hybrid roles
   - keep remote roles explicitly workable from San Diego or the United States
