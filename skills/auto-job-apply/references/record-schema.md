...
- `Referral lead - ask friend`: plausible Acme role that should pause for referral outreach before any direct application; score and tailored artifacts may be present even below the normal 70 threshold.
