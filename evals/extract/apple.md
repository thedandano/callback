...
- Partner with data scientists to productionize and deploy personalization algorithms, ensuring models are scalable, reliable, and performant in production environments.
- Design and build data pipelines to generate and process large-scale datasets used for personalization and user targeting initiatives.
- Develop and maintain systems for delivering timely, personalized notifications to users across multiple channels.
- Monitor and optimize production systems for latency, throughput, and reliability, implementing improvements as usage scales.
- Collaborate cross-functionally with data scientists, product managers, and other engineers to translate business requirements into robust technical solutions.
- Contribute to code reviews, technical design discussions, and engineering best practices to raise the overall quality and health of the codebase.

- 5+ years building resilient, high-scale distributed microservices in production (serving millions of users or comparable event/request volume)
- Proficiency in Java or another object-oriented language
- Production experience designing and operating event-driven / streaming systems (e.g., Kafka, Kinesis, Pulsar) — pub/sub, async, or stream processing at scale
- Hands-on experience building large-scale data pipelines on a big-data framework (e.g., Apache Spark)
- Experience productionizing personalization / recommendation / ranking algorithms — deploying, serving, and monitoring them in a live system (not offline training only)
- Experience building or operating notification / message-delivery systems across one or more channels (push, email, SMS, in-app)
- Proficient in algorithms and data structures
- Experience with SQL & NoSQL datastores (e.g., PostgreSQL, Cassandra, DynamoDB, MySQL) and Redis
- Bachelor’s degree in CS, CE, EE, or a related technical field — or equivalent industry experience
- Effective written and verbal communication; able to make progress with incomplete requirements

- Experience partnering directly with data scientists to move models from notebook to production.
- Feature stores, online/offline serving, model monitoring, and A/B experimentation.
- Multi-channel delivery at scale — rate-limiting, dedup, and delivery-guarantee design.
- Experience with CI/CD and cloud environments (AWS, GCP, or Azure).
- Advanced stream/data processing (e.g., Flink, Beam, Spark Structured Streaming).
