...
- Restart Claude Code sessions in `/Users/dandano/workplace/callback` so the new MCP
...
- Old `~/.claude/projects/-Users-dandano-workplace-pi-apply/` dir left in place; delete once
