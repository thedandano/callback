...
Diego, $NNNk, domain lists, FAANG/Acme referral logic) and absolute file
paths (`~/...`, the CSV/ledger/EDD locations). Per review comments,
...
class SearchPreferences(BaseModel):
    ...
    referral_companies: list[ReferralCompany] = Field(default_factory=list)  # replaces hardcoded Acme "ask friend"
