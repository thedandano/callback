...
- `preferred_any` OR-groups — the same primitive on the preferred side: disjunctions in a nice-to-have section score as a single preferred unit at preferred weight; unmatched groups surface as `score_gap.preferred_missing_any`.
...
* **release:** bump plugin manifests with release-please ([091fa85](https://github.com/thedandano/callback/commit/091fa8531ded96fcd9c2e39ba436f998a9e5980a))

## [1.3.0](https://github.com/thedandano/callback/compare/v1.2.1...v1.3.0) (2026-08-22)


### Features

* **scorer:** surface required and preferred keyword coverage ([3546039](https://github.com/thedandano/callback/commit/35460398e479f44d9844a9de812a0b4456644029))
